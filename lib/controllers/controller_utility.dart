import 'package:dewa_movies/controllers/controller_base.dart';
import 'package:dewa_movies/shared/utils/utils.dart';
...
class ControllerUtility extends ControllerBase {
  @override
  void onInit() {
    resetBottomNavState();
    resetHideShowState();
